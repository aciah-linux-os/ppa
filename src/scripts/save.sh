# Nous sommes obligés de modifier le script save.sh pour tenir compte des évolutions de Libre Office.
# Voici la version du 31 octobre 2024, les autres sont en dessous.

#!/bin/bash

# Version 1.3 - 31 octobre 2024
# Auteur : Aciah-octobre 2023
# Licence : GPL v3
# Modifications : Association ACIAH et Gérard Ruau (membre association ACIAH) 31/10/2024
# NAME : save.sh
# DESCRIPTION : Ce script simplifie l'enregistrement de documents LibreOffice.
...
# On lance le script save.sh en frappant la touche Coeur et ensuite la touche A, à condition d'avoir réglé cela dans le menu (voir ci-dessus).
# Le programme demande d'écrire le nom du fichier
# On a tout le temps pour taper un nom de fichier
# On descend ensuite sur le dossier de son choix
# et on valide deux fois.
...
#### Commandes pour aller dans le dossier désiré
	...
	sleep 1
        ...
        amixer -q  -D pulse sset Master toggle
        sleep 1
        espeak -a 200 -v mb-fr1 -s 120 "donc écri vez le nom de votre docu ment"
	sleep 4

    espeak -a 200 -v mb-fr1 -s 130 "puis descendez sur le dossier de votre choix et validez deux fois"
